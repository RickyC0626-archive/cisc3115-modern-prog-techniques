public class TestTV
{
  public static void main(String[] args)
  {
    ...
    System.out.println("The manufacturing date of the TV is " + tv1.getManufacturingDate());
    System.out.println("tv2's channel is " + tv2.getChannel() + " and volume level is " + tv2.getVolumeLevel());
    System.out.println("The manufacturing date of the TV is " + tv2.getManufacturingDate());
  }
}
